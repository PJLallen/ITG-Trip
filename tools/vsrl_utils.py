...
def load_vcoco(imset, dir_name=None):
  if dir_name is None:
    dir_name = get_data_dir() #/mnt/iMVR/jiaan/gen-vlkt/tools/data
    # print(dir_name) #/mnt/iMVR/jiaan/gen-vlkt/tools/data
  # print(os.path.join(dir_name, 'vcoco', imset + '.json')) # '/mnt/iMVR/jiaan/gen-vlkt/tools/data/vcoco/vcoco_trainval.json'
  with open(os.path.join(dir_name, 'vcoco', imset + '.json'), 'rt') as f:
    vsrl_data = json.load(f)
  # print(vsrl_data)
  vsrl_data = unicode_to_str(vsrl_data)
  with open(os.path.join('tools/','vsrl_data.json'), 'w') as f:
        json.dump(vsrl_data, f)
  # print(vsrl_data)
  # print(len(vsrl_data)) #4
  # for i in range(len(vsrl_data)):
  #   print(i)
  #   print(vsrl_data.keys()) #[u'images', u'type', u'annotations', u'categories']
  #   print(np.array(vsrl_data[i]['role_object_id']))
  #   print(np.array(vsrl_data[i]['role_object_id']).reshape((len(vsrl_data[i]['role_name']),-1)).T)
