...
class GEN_VLKT(nn.Module):
    ...
    def init_classifier_with_CLIP(self, hoi_text_label, obj_text_label, unseen_index):
        ...
        return text_embedding.float(), obj_text_embedding.float(), hoi_text_label_del, obj_text_inputs, text_embedding_del.float()
...
class SetCriterionHOI(nn.Module):
    ...
    def loss_obj_labels(self, outputs, targets, indices, num_interactions, log=True):
        ...
        loss_obj_ce = F.cross_entropy(src_logits.transpose(1, 2), target_classes, self.empty_obj_weight) 
    ...
    def loss_sub_labels(self, outputs, targets, indices, num_interactions, log=True):
        ...
        sub_src_logits = outputs['pred_sub_logits'] 
        ...
        target_classes[idx] = target_classes_o 
        loss_sub_ce = F.cross_entropy(sub_src_logits.transpose(1, 2), target_classes, self.empty_sub_weight) 
